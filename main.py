...
async def perform_emote(team_code: str, uids: list, emote_id: int):
    global key, iv, region, online_writer, BOT_UID, whisper_writer
    ...
    try:
        ...
        return {"status": "success", "message": "Emote done"}  # লিভ ছাড়া

    except Exception as e:
        print(f"Perform emote error: {e}")
...
def join_team():
    ...
    print(f"[API CALL] Team: {team_code}, UIDs: {uid1}, Emote: {emote_id_str}")
